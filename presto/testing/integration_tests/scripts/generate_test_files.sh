...
for BENCHMARK_TYPE in tpch tpcds; do
  ...
  python $BENCHMARK_DATA_TOOLS_DIR/generate_table_schemas.py --benchmark-type $BENCHMARK_TYPE --schemas-dir-path $SCHEMAS_DIR
  ...
  python $BENCHMARK_DATA_TOOLS_DIR/generate_query_file.py --benchmark-type $BENCHMARK_TYPE --queries-dir-path $QUERIES_DIR
  ...
  python $BENCHMARK_DATA_TOOLS_DIR/generate_data_files.py --benchmark-type $BENCHMARK_TYPE --data-dir-path $DATA_DIR --scale-factor $SCALE_FACTOR
