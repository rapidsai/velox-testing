...
ARG CPM_GIT_SHALLOW=FALSE
ARG CPM_PACKAGE_rapids_logger_GIT_TAG=main
...
ENV CPM_GIT_SHALLOW=${CPM_GIT_SHALLOW}
ENV CPM_PACKAGE_rapids_logger_GIT_TAG=${CPM_PACKAGE_rapids_logger_GIT_TAG}
ENV EXTRA_CMAKE_FLAGS=${EXTRA_CMAKE_FLAGS} -DCPM_GIT_SHALLOW=${CPM_GIT_SHALLOW} -DCPM_PACKAGE_rapids_logger_GIT_TAG=${CPM_PACKAGE_rapids_logger_GIT_TAG}
