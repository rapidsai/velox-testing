...
OPTIONS:
    ...
    -j, --num-threads    Number of threads to use when building the image.
                         Defaults to -j0, sized like RAPIDS build scripts for sccache-dist.
...
NUM_THREADS="${n_jobs}"
export NINJA_LOAD_LIMIT="${n_load}"
