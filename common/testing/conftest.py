...
"""Shared pytest configuration for TPC-H and TPC-DS test parametrization."""


def pytest_generate_tests(metafunc):
    """Generate test parameters for TPC-H and TPC-DS queries."""
...
def set_query_id_param(metafunc, param_name, num_queries, disabled_queries):
    """Set query ID parameter for test parametrization."""
...
def parse_selected_query_ids(selected_query_ids, num_queries):
    """Parse comma-separated query IDs from command line option."""
    query_ids = []
