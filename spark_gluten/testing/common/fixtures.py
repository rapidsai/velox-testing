...
SPARK_CONNECT_DEFAULT_HOST = "localhost"
...
def spark_session(request):
    ...
    hostname = request.config.getoption("--hostname", default=SPARK_CONNECT_DEFAULT_HOST)
    port = request.config.getoption("--port", default=SPARK_CONNECT_DEFAULT_PORT)
